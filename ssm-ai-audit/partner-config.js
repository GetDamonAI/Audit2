(function () {
  ...
  const PARTNER_CONFIG = {
    telus: {
      ...
      lockupName: "TELUS",
      logoHeight: "92px",
      logoHeightTablet: "92px",
      logoHeightDesktop: "92px",
      logoScale: 1,
      logoScaleTablet: 1,
      logoScaleDesktop: 1,
      logoMaxWidth: "260px",
    ...
    bctech: {
      ...
      lockupName: "BC Tech",
      logoHeight: "98px",
      logoHeightTablet: "98px",
      logoHeightDesktop: "98px",
      logoScale: 1,
      logoScaleTablet: 1,
      logoScaleDesktop: 1,
      logoMaxWidth: "260px",
    ...
    elearningu: {
      ...
      logoHeight: "56px",
      logoHeightTablet: "56px",
      logoHeightDesktop: "56px",
      logoScale: 1,
      logoScaleTablet: 1,
      logoScaleDesktop: 1,
      logoMaxWidth: "260px",
