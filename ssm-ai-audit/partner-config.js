(function () {
  ...
  const PARTNER_CONFIG = {
    telus: {
      ...
      lockupName: "TELUS",
      logoHeight: "132px",
      logoHeightTablet: "144px",
      logoHeightDesktop: "156px",
      logoScale: 1.45,
      logoScaleTablet: 1.55,
      logoScaleDesktop: 1.65,
      logoGapAfter: "18px",
      subhead: "",
    ...
    bctech: {
      ...
      lockupName: "BC Tech",
      logoHeight: "108px",
      logoHeightTablet: "116px",
      logoHeightDesktop: "124px",
      logoScale: 1.08,
      logoScaleTablet: 1.1,
      logoScaleDesktop: 1.12,
      logoGapAfter: "8px",
      subhead: "",
    ...
    smallbusinessbc: {
      ...
      logoHeight: "114px",
      logoHeightTablet: "122px",
      logoHeightDesktop: "130px",
      logoScale: 1.12,
      logoScaleTablet: 1.14,
      logoScaleDesktop: 1.16,
      logoGapAfter: "10px",
      subhead: "",
